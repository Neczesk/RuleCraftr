...
import { fetchArticlesForRuleset, fetchKeywordsForRuleset, fetchRuleset, fetchRulesetsForUser, insertRuleset, putRulesetMetadata, deleteRuleset as netDeleteRuleset } from "../network/rulesets";
import { deleteKeywords, postKeywords, updateKeywords } from "../network/keywords";
import { buildArticleTree, deleteArticle, findArticleInTree, sortArticle, treeToArray } from "./articles";
...
export function addArticle(parentId, ruleset, newArticle){
    ...
    if (parentArticle) {
        parentArticle.childrenArticles = parentArticle.childrenArticles ? [...parentArticle.childrenArticles, newArticle] : [newArticle]
    } else {
