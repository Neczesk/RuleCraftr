...
export async function updateKeywords(keywordData) {
    ...
    const putData = keywordData.map((keyword) => ({id: keyword.id, long_definition: keyword.longDefinition, short_definition: keyword.shortDefinition, keyword: keyword.keyword}))
