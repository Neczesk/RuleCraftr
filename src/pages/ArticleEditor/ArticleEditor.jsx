...
import { Button, IconButton, ButtonGroup, Box, TextField, styled, Toolbar, Stack } from '@mui/material'
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Box alignContent="center" justifyContent="center" display="flex" sx={{ mt: 5 }}>
            <StyledTextField
              id="article-title"
              label="Title"
              variant="outlined"
