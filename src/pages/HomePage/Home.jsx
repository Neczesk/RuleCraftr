  ...
  return (
    <Container sx={{ padding: 5 }}>
      ...
      <Typography variant="body1" align="center">
        ...
        favorite unit game breakingly overpowered, but it can help you organize your thoughts, cross reference your own
        rules so you only need to write them once, and export them into a convenient html document for easy reading from
        a mobile device, e-reader, or other device.
      </Typography>
      <hr></hr>
      <Typography variant="body1" align="center">
        Welcome alpha testers! As you can probably guess looking at it, the app isn{"'"}t finished yet. I appreciate you
        giving this a try for me. By the time this is published there{"'"}ll be a discord server where you can let me
        know your feedback and any bugs you encounter. As of now, the following features are available:
      </Typography>
      <ul>
        <li>
          Creating your user account (Use the invite code you received from me if you have one, otherwise you{"'"}re not
          getting in yet)
        </li>
